...
namespace SalonManagementSystem.DAL
{
    public static class DatabaseInitializer
    {
        ...
        {
            string connectionString = config.GetConnectionString("SalonDB");
            ...
            try
            {
                ...
                {
                    masterConn.Open();
                    string checkDbSql = $"IF DB_ID('{targetDatabase}') IS NULL CREATE DATABASE [{targetDatabase}];";
            ...
            {
                // Master database permissions may be restricted; proceed with direct target database connection
            }
